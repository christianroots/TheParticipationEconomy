  ...
  return (
    <main className="bg-white">
      ...
      <div className="max-w-content mx-auto px-6 md:px-8">
        ...
        {/* Section 6.5 — The Fiscal Case (replaces Government Match) */}
        <AnimatedSection id="fiscal-case" className="pt-4">
          <SectionLabel>Part Five-B</SectionLabel>
          <SectionHeading>How the Government Gets Paid.</SectionHeading>
          <BodyText>
            <p>
              Here&rsquo;s the part that makes this politically viable. The
              government doesn&rsquo;t match anything. It doesn&rsquo;t spend
              anything. It creates the mechanism &mdash; the legislation, the
              regulatory framework, the ETF structure &mdash; and then it sits
              back and collects.
            </p>
            <p>
              Because the citizen portfolios generate three distinct tax revenue
              streams, all of which grow faster than any upfront cost:
            </p>
          </BodyText>
          ...
          <div className="my-8 p-6 bg-pull-bg rounded-lg border border-green-200">
            ...
            <div className="space-y-2 font-serif text-[15px] leading-[1.7] text-text">
              <p>
                ...
                to the state. The rest passes to heirs. This alone generates
                enormous revenue once the portfolios mature.
              </p>
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-12">
            <StatCallout
              number="&pound;0"
              description="Government upfront cost"
              delay={0}
            />
            <StatCallout
              number="30%"
              description="Participation tax at death"
              delay={0.15}
            />
            <StatCallout
              number="&pound;80B+"
              description="Projected annual tax revenue by year 50"
              delay={0.3}
            />
          </div>
          ...
          <BodyText>
            <p>
              The government spends nothing. It legislates a mechanism. The
              mechanism builds &pound;10 trillion in citizen assets over one
              generation. The death tax, capital gains tax, and dividend tax on
              those assets generate over &pound;80 billion per year by the
              fiftieth year. And all of that is before counting the indirect
              fiscal benefits: reduced welfare dependency, increased consumer
              spending from daily drawdowns, higher corporation tax from
              companies funded by citizen capital.
            </p>
          </BodyText>

          <PullQuote>
            The government spends nothing. Creates a mechanism.
            Collects &pound;80 billion a year in tax revenue within a
            generation. That&rsquo;s not policy. That&rsquo;s the best trade
            the Treasury never made.
          </PullQuote>
        </AnimatedSection>
