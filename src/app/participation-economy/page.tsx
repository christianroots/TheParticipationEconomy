    ...
    <main className="bg-white">
      ...
      <div className="max-w-content mx-auto px-6 md:px-8">
        ...
        <AnimatedSection id="fiscal-case" className="pt-4">
          ...
          <BodyText>
            <p>
              Now here&rsquo;s the commitment. For the first thirty years, the
              government doesn&rsquo;t keep any of it. Every penny of CGT,
              death tax, and dividend tax generated by the participation
              portfolios gets reinvested directly back into the citizen fund.
            </p>
            <p>
              ...
              tax revenue and pour it back into the machine. The state is
              saying: we believe in this enough to wait. We&rsquo;ll take our
              return later, when the fund is enormous, and our cut of it is
              worth the patience.
            </p>
            <p>
              In practice, this functions exactly like a match &mdash; except
              it costs the Treasury nothing from existing budgets. The system
              generates its own match from its own returns. In the early years
              the reinvested amounts are small. But they compound. By year
              fifteen, the reinvested tax revenue is adding billions per year
              to the citizen fund. By year twenty-five, it&rsquo;s
              accelerating the growth rate dramatically. The fund grows faster
              than it would with a traditional match, because the reinvestment
              itself compounds.
            </p>
          </BodyText>
