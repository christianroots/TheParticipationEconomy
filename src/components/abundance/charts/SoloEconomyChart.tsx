    ...
    <div ref={ref}>
      ...
      <div className={`transition-opacity duration-700 ${visible ? "opacity-100" : "opacity-0"}`}>
        {view === "formations" ? (
          ...
          <>
            <p className="font-mono text-[11px] text-at-muted mb-2">
            ...
            <div className="flex gap-3 mb-4 flex-wrap">
              <div className="bg-at-surface border border-at-rule/30 rounded px-3 py-2">
                <p className="font-mono text-[10px] text-at-muted">5.5m</p>
                <p className="font-mono text-[9px] text-at-muted/60">US businesses formed 2023</p>
              </div>
              <div className="bg-at-surface border border-at-rule/30 rounded px-3 py-2">
                <p className="font-mono text-[10px] text-at-muted">49%</p>
                <p className="font-mono text-[9px] text-at-muted/60">survive to year 5</p>
              </div>
              <div className="bg-at-surface border border-at-rule/30 rounded px-3 py-2">
                <p className="font-mono text-[10px] text-at-muted">7–11</p>
                <p className="font-mono text-[9px] text-at-muted/60">avg employees at Y5</p>
              </div>
            </div>
            <ResponsiveContainer width="100%" height={380}>
              <BarChart data={y5Data} margin={{ top: 20, right: 10, left: 10, bottom: 10 }}>
                ...
                <Bar dataKey="jobs" name="Jobs at Y5" fill={G} radius={[3, 3, 0, 0]} animationDuration={1200} animationBegin={400}>
                  <LabelList dataKey="jobs" position="top" fill="#8A9E8D" fontSize={10} fontFamily="var(--font-ibm-plex-mono)" formatter={(v) => `${v}m`} />
                </Bar>
              </BarChart>
            </ResponsiveContainer>
          </>
